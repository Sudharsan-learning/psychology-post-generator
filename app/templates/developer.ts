...
export function buildDeveloperTemplate(
  slides: Slide[],
  config: PostConfig,
  theme: "dark" | "light"
): string {
    ...
    .map((slide, i) => {
      ...
      if (isCover) {
        ...
        <div class="slide cover" data-slide="${i}">
          ...
          <div class="terminal-body">
            <div class="term-line"><span class="prompt">$</span> <span class="cmd">node</span> <span class="arg">tricks.js</span></div>
            ...
            ${subtext ? `<div class="cover-sub"><span class="comment">${subtext}</span></div>` : ""}
            <div class="term-gap"></div>
            <div class="term-gap"></div>
      ...
      if (slide.isCta) {
        ...
        <div class="slide cta-slide" data-slide="${i}">
          <div class="win-chrome">
            <div class="dots"><span class="d r"></span><span class="d y"></span><span class="d g"></span></div>
            <div class="win-title">action.sh</div>
            <div class="win-right">bash</div>
          </div>
      ...
      return `
        <div class="slide content-slide" data-slide="${i}">
          ...
          <div class="win-chrome">
            <div class="dots"><span class="d r"></span><span class="d y"></span><span class="d g"></span></div>
            <div class="win-title">${eyebrow ? eyebrow.toLowerCase().replace(/\s+/g, "_") + ".js" : "tip_" + num + ".js"}</div>
          ...
          <div class="editor-body">
            ...
            <div class="code-area">
              ...
              ${subtext
                ? subtext.split("\n").map((line, li) =>
                    `<div class="code-line"><span class="comment${li === 0 ? " comment-first" : ""}">${escapeHtml(line.trim())}</span></div>`
                  ).join("\n")
                : ""}
            </div>
          </div>
...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  .slide{
    ...
    position:relative;
    overflow:hidden;
    box-shadow:0 0 0 1px var(--border), 0 16px 40px rgba(0,0,0,0.7);
    display:flex;
