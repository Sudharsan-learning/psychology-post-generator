 ...
 * Eliminates duplicated inline SVG markup across page.tsx, SlideBuilder, LivePreview, etc.
 */
...
export function GalleryIcon({ className = "w-4 h-4" }: IconProps) {
  return (
...
export function UploadIcon({ className = "w-3.5 h-3.5" }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
...
export function SaveIcon({ className = "w-3.5 h-3.5" }: IconProps) {
  return (
...
export function ArrowRightIcon({ className = "w-2.5 h-2.5" }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
